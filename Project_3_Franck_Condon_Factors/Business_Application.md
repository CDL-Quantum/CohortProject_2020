...
Maureen Downey, the “the Sherlock Holmes of Wines,” is an independent expert on fine and rare wine and wine collection management. She estimates that counterfeit wines sold on the secondary market account for billions of dollars in losses each year to the wine industry. Nearly all the anti-fraud techniques currently available are cosmetic, meaning they simply involve analyzing the visual appearance of the wine, bottle, and label. These methods are notoriously unreliable, especially when a large portion of wine counterfeiters deal in refilling authentic bottles. 
